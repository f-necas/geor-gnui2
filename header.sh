...
SNIPPET="<script src='${SCRIPT}'></script><geor-header active-app='datahub' logo-url='${LOGO}' legacy-header='${LEGACY}' legacy-url='${LEGACY_URL}' style='height:${HEIGHT}px' stylesheet='${STYLESHEET}'></geor-header>"
